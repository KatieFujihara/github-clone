...
class Form extends React.Component {
  ...
  handleSubmit = event => {
    ...
    api.call(this.state.userName).then(response => {
      ...
      <div className={styles.row}>
        <div className={styles.col1}>
          <div className={styles.info}>
            ...
            <p>
              way you work. From <a href="#">open source</a> to{" "}
              <a href="#">business</a>, you{" "}
            </p>
        ...
        <div className={styles.col2}>
          <form onSubmit={this.handleSubmit} className={styles.searchForm}>
            ...
            <p className={styles.text}>
              By clicking “Search on GitHub”, you agree to our terms of service
  ...
  return (
    <div className={appStyles.results}>
      <a href={props.html_url}>
          ...
          <br />
          <a href={props.html_url}>
            <img className={appStyles.link} src={github} />
          </a>
      </a>
    </div>
  );
...
const CardList = props => {
  if (props.cards.length === 0) {
    ...
    return (
      <div>
        <ul>
          <h1 className={appStyles.users}>{props.cards.length} Users</h1>
          {props.cards.map(card => (
            <Card {...card} key={card.id} />
          ))}
        </ul>
